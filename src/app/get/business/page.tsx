 ...
 * WhatsApp des nouveaux assistants / vendeurs : l'URL envoyée ne change
...
export default async function GetBusinessPage() {
    ...
    <div className="pt-28 lg:pt-32 min-h-screen bg-[#F8FAFC]">
      <section className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 text-center">
        ...
        <p className="mt-6 text-lg text-[#1F492E]/60 max-w-xl mx-auto">
          ...
          Choisissez votre boutique ci-dessous.
        </p>
        ...
        {!STORE_LINKS.ios && (
          <p className="mt-10 text-sm text-[#1F492E]/50">
